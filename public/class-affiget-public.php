...
class AffiGet_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in AffiGet_Public_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The AffiGet_Public_Loader will then create the relationship
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/affiget-public.js', array( 'jquery' ), $this->version, false );
